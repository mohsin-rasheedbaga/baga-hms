...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  if (lt === 'pharmacy') {
    ...
    // Hospital (default) or demo: show all menus to ALL users regardless of role
    // Role-based menu restriction removed — every user sees all module menus
  ...
  // If user has 'all' permissions or is master admin, show everything
  const userPermissions: string[] = session?.permissions || [];
  const hasAllPermissions = userPermissions.includes('all') || session?.role === 'super_admin';
